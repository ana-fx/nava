...
<head>
    ...
    <meta name="description"
        content="{{ $description ?? 'Nava provides cutting-edge technology solutions and professional services. We are committed to delivering innovative software development, technology consulting, and support services to help businesses achieve their goals.' }}">
    <meta name="keywords"
        content="{{ $keywords ?? 'technology solutions, software development, IT consulting, technology services, web development, digital transformation, Nava, Ponorogo, Indonesia' }}">
    ...
    <meta property="og:description"
        content="{{ $description ?? 'Nava provides cutting-edge technology solutions and professional services. We are committed to delivering innovative software development, technology consulting, and support services.' }}">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Playfair+Display:ital,wght@0,400;0,600;0,700;1,400;1,600&display=swap"
        rel="stylesheet" />
...
<body
    class="bg-artisan-bg-light dark:bg-dark-bg text-artisan-black dark:text-artisan-white antialiased overflow-x-hidden">
