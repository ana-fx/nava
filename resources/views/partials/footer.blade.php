    ...
    <div class="container mx-auto px-6 lg:px-8 max-w-7xl">
        <div class="pt-12 pb-12 grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div data-aos="fade-up" data-aos-delay="200">
                <h4 class="text-sm font-semibold mb-4 text-white uppercase tracking-wide">Quick Links</h4>
                <ul class="space-y-3">
                    <li>
            ...
            <div data-aos="fade-up" data-aos-delay="300">
                <h4 class="text-sm font-semibold mb-4 text-white uppercase tracking-wide">Contact</h4>
                <ul class="space-y-3 text-sm text-gray-400">
                    <li class="flex items-start gap-2">
                        <i class="fi fi-rr-envelope mt-0.5"></i>
                        <span>info@nava.com</span>
                    </li>
                    <li class="flex items-start gap-2">
